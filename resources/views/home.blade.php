    ...
    <div class="wrap-slick1">
        <div class="slick1">
            ...
            <div class="item-slick1" style="background-image: url('{{$slider->thumb}}')">
                <div class="container h-full" style="font-family: 'Arial', sans-serif;">
                    <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
                        <div class="layer-slick1 animated visible-false" data-appear="fadeInDown" data-delay="0">
                            <span class="ltext-101 cl2 respon2" style="font-family: 'Arial', sans-serif;">Bộ sưu tập thời trang 2024</span>
                        </div>
                        <div class="layer-slick1 animated visible-false" data-appear="fadeInUp" data-delay="800">
                            <h2 class="ltext-201 cl2 p-t-19 p-b-43 respon1" style="font-family: 'Arial', sans-serif;">
                                {{$slider->name}}
                            </h2>
                        </div>
                ...
                <div class="block1 wrap-pic-w">
                    ...
                    <a href="/danh-muc/{{$menu->id}}-{{\Str::slug($menu->name,'-')}}.html" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
                        <div class="block1-txt-child1 flex-col-l">
                            <span class="block1-name ltext-102 trans-04 p-b-8">{{$menu->name}}</span>
                            <span class="block1-info stext-102 trans-04">HOT 2024</span>
                        </div>
