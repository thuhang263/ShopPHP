                ...
                <div  class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="size" value="{{old('size')}}" class="form-control" placeholder="Nhập size">
                     ...
                     <div class="col-md-6">
                         <div class="form-group">
                             ...
                             <input type="text" name="color" value="{{old('color')}}" class="form-control" placeholder="Nhập màu sắc">
                         </div>
                     </div>
                </div>
