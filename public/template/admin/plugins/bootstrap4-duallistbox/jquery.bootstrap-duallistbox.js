...
(function(factory) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      eventMoveOverride: false,                                                           // boolean, allows users to unbind default event behaviour and run their own instead
      eventMoveAllOverride: false,                                                        // boolean, allows users to unbind default event behaviour and run their own instead
      eventRemoveOverride: false,                                                         // boolean, allows users to unbind default event behaviour and run their own instead
      eventRemoveAllOverride: false,                                                      // boolean, allows users to unbind default event behaviour and run their own instead
